...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(XepLoai.GPA);
		System.out.println(XepLoai.GPA.getCode());
		XepLoai.GPA.setCode("hihi");
		System.out.println(XepLoai.GPA);
		System.out.println(XepLoai.GPA.getCode());
...
//				break;
//			case "4":			
//				listStudent.sort("GPA");								//Xếp danh sách theo điểm trung bình
//				StudentInfoDAO.saveData(listStudent);
//				break;
//			case "5":
//				listStudent.sort("ID_STUDENT");								//Xếp danh sách theo mã học sinh
//				StudentInfoDAO.saveData(listStudent);
//				break;
//			case "6":
